...
public class App02 {
    ...
    public void calculateNumbers() {
        ...
        while(!b){
            try{
                parser.parseFirstNum(scanner.nextLine());
                b = true;
        ...
        while(!b){
            try{
                parser.parseOperator(scanner.nextLine());
                b = true;
        ...
        double answer = parser.executeCalculator();
    ...
    public void option() {
        ...
        while(!parser.readNumber(numberString) || Integer.parseInt(numberString) <= 0 || Integer.parseInt(numberString) > 3){
